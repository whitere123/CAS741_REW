...
\item[M8:] Eigenvalue and Eigenvector Solver Module. \\
\item[M9:] Diagonal Matrix Generator Module.\\ 
\item[M10:] Elliptic Integral Module. \\
\item[M11:] Elliptic Functions Module. \\
\item[M12:] Plotting Module. \\ 
\item[M13:] Linspace Module. \\ 
\item[M14:] Control Module. \\
\end{description}
...
\subsubsection{Output Format Module (M3)}
...
\subsubsection{Spectrum Matrix Module (M4)}
...
\subsubsection{Exact Eigenvalue Equations Module (M5)}
...
\begin{description}
	...
	literature. These two values will be used by the Lambda Error Equation 
	Module. 
	\item[Implemented By:] SpecSearch
\end{description}

\subsubsection{Spectrum Error Equation Module (M6)}
...
\begin{description}
	...
	theoretical eigenvalues. This module will be used by the 
	plotting module. 
	\item[Implemented By:] SpecSearch
\end{description} 

\subsubsection{Numerical Parameters Module (M7)} 
...
\subsubsection{Control Module (M14)} 
...
\subsubsection{Eigenvalue and Vector Solver Module (M8)} 
...
\subsubsection{Diagonal Matrix Module (M9)} 
...
\subsubsection{Elliptic Integral Module (M10)} 
...
\subsubsection{Elliptic Functions Module (M11)} 
...
\begin{description}
	...
	and sn for a particular domain/vector. This module will be used by the 
	operator 
	matrix module. 
	\item[Implemented By:] MATLAB
\end{description} 

\subsubsection{Plotting Module (M12)} 
...
\subsubsection{Linpsace Module (M13)} 
...
\node [block, below of=init] (evaluate) {Elliptic Integral (M11)};
