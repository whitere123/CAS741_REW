...
Nov 9 & 1.3 & Implementation of updated MG template. \\ 
\bottomrule
\end{tabularx}
...
\node [block, below of=out,node distance=3.5cm] (diag) {Diagonal Matrix (M9)} ;
\node [block, below of=diag,node distance=2.5cm] (elipfun) {Elliptic Functions 
(M11)} ;
\node [block, below of=elipfun,node distance=2.5cm] (linspace) {linspace (M13)} 
;
\node [block, below of=linspace,node distance=2.5cm] (elipint) {Elliptic 
Integral 
(M10)} ; 
\node [block, below of=elipint,node distance=2.5cm] (input) {Input Parameters 
(M2)} ;
\node [block, left of=diag, node distance=3cm] (specmat) {Spectrum Matrix (M4)};
\node [block, left of=linspace, node distance=3cm] (numpar) {Numerical 
Parameters (M7)};
\node [block, right of=linspace, node distance=6cm] (exacteig) {Exact Eigen 
Value Equations (M5)};
...
\path [line] (specmat) -- (diag);
\path [line] (specmat) -- (elipfun);
\path [line] (diag) -- (elipfun); 
\path [line] (elipfun) -- (linspace); 
\path [line] (linspace) -- (numpar); 
